...
const Hero = ({ isDarkMode, textSub }) => {
  ...
  return (
    <section
      className={`relative min-h-screen flex items-center justify-center overflow-hidden px-5 transition-colors duration-500 ${
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-6xl flex flex-col lg:grid lg:grid-cols-2 lg:gap-16 items-center py-20 gap-10">
        ...
        >
          ...
          >
            ...
            />
            <div
              className={`absolute inset-0 bg-gradient-to-t from-black/70 via-black/10 to-transparent transition-opacity duration-700 ${
                isHovered ? 'opacity-20' : 'opacity-50'
              }`}
            />
            <div
              className={`absolute bottom-5 left-5 right-5 flex items-center justify-between transition-all duration-500 ${
        ...
        >
          <motion.div
            ...
            className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-[10px] font-black tracking-[0.15em] uppercase mb-6 border backdrop-blur-md shadow-sm ${
              isDarkMode
          ...
          <h1 className="text-5xl sm:text-5xl md:text-7xl font-bold mb-3 tracking-tighter">
            Who <span className="font-serif italic font-light text-zinc-500 text-4xl sm:text-4xl md:text-6xl">Am I?</span>
          </h1>
          ...
          <p className={`text-base sm:text-base md:text-lg mb-8 leading-relaxed font-light max-w-lg mx-auto lg:mx-0 ${
            ...
            I specialize in{' '}
            <span className={isDarkMode ? 'text-zinc-100 font-normal' : 'text-zinc-900 font-normal'}>full-stack development</span>,
          ...
          <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3">
            ...
            <div className={`flex items-center gap-2 px-5 py-3 rounded-2xl border backdrop-blur-xl shadow-sm
